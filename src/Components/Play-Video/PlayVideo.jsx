...
import share from '../../assets/like.png'
    ...
    <div className='play-video'>
        ...
        <div className="vid-description">
            ...
            {commentDta.map((item,index)=>{
                ...
                <div>
                    <h3>{item.snippet.topLevelComment.snippet.authorDisplayName.slice(1)} <span>{moment(item.snippet.topLevelComment.snippet.publishedAt).fromNow()} </span></h3>
